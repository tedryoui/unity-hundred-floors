    ...
    public class Queue : MonoBehaviour
    {
        ...
        private void Start()
        {
            for (int i = 0; i < _unitsAmount; i++)
            {
                ...
                GameObject obj = GameCore.GetLevel.GetPool.GetEntity(_unitPrefab.prefab.name);
                obj.transform.position = pos;
                obj.transform.parent = _unitsGroup;
        ...
        public void SetFirstUnit()
        {
            ...
            _player.Group.TryAdd(Head.Transform, _unitPrefab);
